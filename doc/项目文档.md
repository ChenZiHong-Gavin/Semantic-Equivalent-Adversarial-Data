...
<img src="https://latex.codecogs.com/svg.image?\hat{a}=\arg&space;\max&space;_{a&space;\in&space;\mathcal{A}}&space;p(a&space;\mid&space;v,&space;q&space;;&space;\theta)" title="\hat{a}=\arg \max _{a \in \mathcal{A}} p(a \mid v, q ; \theta)" />
$$
